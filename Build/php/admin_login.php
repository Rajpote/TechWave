...
if (isset($_POST['login_submit'])) {
    ...
    $stmt = $conn->prepare("SELECT * FROM admin_register WHERE email=:email");
    ...
    if ($userauth && password_verify($password, $userauth['password'])) {
        ...
        $_SESSION['aname'] = $userauth['email'];
        $_SESSION['a_id'] = $userauth['id'];
                ...
                <div class="p-10 backdrop-blur-xl rounded-xl">
                    <form action="" method="post" class="flex flex-col space-y-4">
                        ...
                        <div class="flex justify-between items-center">
                            ...
                            <a href="admin_register.php" class="text-blue-800 text-sm">Sign Up</a>
                        </div>
